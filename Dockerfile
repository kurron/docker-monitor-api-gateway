...
ADD https://bintray.com/artifact/download/kurron/maven/org/kurron/example/monitor-api-gateway/1.2.0.RELEASE/monitor-api-gateway-1.2.0.RELEASE.jar /opt/example/application.jar
